...
export const MOCK_CASES = [
  ...
  {
    id: "case_mental_cheng",
    name: "阿誠 (精神健康 - 抑鬱及社交焦慮症)",
    category: "精神健康 (抑鬱症 / 焦慮症)",
    avatar: "🧠",
    age: 32,
    gender: "男",
    health_condition: "重度抑鬱症康復期與社交焦慮症 (前 IT 網頁程式員)",
    previous_job: "高級網頁開發工程師 (工作6年)",
    family: "與年邁母親同住沙田公屋，父親早逝，家庭經濟壓力沉重",
    welfare: "正申請綜援及傷殘津貼，精神科定期覆診中",
    emotional_state: "強烈自責與社交恐慌，對「程式員技術迭代與AI發展」感到極度被淘汰與自我廢人化。對傳統高壓職場極度逃避。",
    icf_factors: [
      { text: "重度抑鬱症康復期與社交焦慮症", type: "health_condition" },
      { text: "注意力集中時間短，易焦慮引發胸悶手震，睡眠障礙", type: "body_functions" },
      { text: "無法應對長時間高壓加班，面試實體溝通出現語塞與眼神逃避", type: "activities" },
      { text: "待業24個月，長期匿居家中打機，中斷所有朋友社交與求職", type: "participation" },
      { text: "【阻礙】傳統科技公司要求極高壓加班 (996) 且職場競爭激烈", type: "environmental_factors" },
      { text: "【促進】勞工處「展能就業計劃」提供僱主在職試用津貼 (每月最高$5,000)", type: "environmental_factors" },
      { text: "【促進】社福機構「ERB 轉銜輔助文職課程」與彈性居家工作 (WFH) 配對", type: "environmental_factors" },
      { text: "32歲，大學計算機科學畢業，前端 HTML/JS 基礎深厚", type: "personal_factors" },
      { text: "內在核心價值：希望靠專業自立養家、減輕母親經濟負擔", type: "personal_factors" },
      { text: "責任感強但完美主義，極度害怕被視為「精神病廢人」", type: "personal_factors" }
    ],
    initial_dialogue: "「社工，我已經兩年冇工作……依家 IT 科技變到咁快，AI 又出埋，我手技能早就被淘汰。每次想填 Resume 報工，我心口就窒息咁痛。我係咪已經成個廢人咁，只可以靠老母照顧？……」",
    roleplay_flow: [
      {
        user: "阿誠，聽得出這兩年待業同對科技變化嘅恐懼，好似一塊巨石咁壓喺你心口，令你覺得自己跟唔上手腳、甚至質疑自己作為兒子的價值。但你今日願意踏出屋企房門黎到中心同我傾，這證明你內心其實好希望為屋企承擔，對嗎？",
        ai_reply: "「……係，我睇住老母咁大年紀仲要幫人做清潔交租，我真係好自責。但我一諗到去公司面試要同人擠地鐵、要在人面前寫 Code 測試，我就驚到想嘔……我真係做唔到以前咁高壓嘅生活。」",
        coach_hint: "【ACT/MI 提示】：案主展現了「為母親分擔」的核心價值，但被「高壓工作等於唯一出路」的認知框架困住。請引導他接納目前的心理限度，進行「認知解離」，並介紹香港「展能就業計劃」下的彈性居家工作 (WFH) 或半日制轉銜職位。"
      }
    ]
  },
  {
    id: "case_asd_kahou",
    name: "家豪 (神經多樣性 - 自閉症譜系 ASD)",
    category: "神經多樣性 / ASD 自閉症",
    avatar: "🧩",
    age: 22,
    gender: "男",
    health_condition: "自閉症譜系障礙 (ASD - 高功能) 伴隨輕度社交溝通障礙",
    previous_job: "特殊學校職前培訓，曾於連鎖超市實習物料整理 (6個月)",
    family: "與父母及妹妹同住葵涌，母親全職照料",
    welfare: "領取普通殘疾津貼，參與「陽光路上」就業培訓計劃",
    emotional_state: "非言語溝通刻板，對陌生環境與流程變動極度不安，但對數據分類與物品擺放極為精準且堅持原則。",
    icf_factors: [
      { text: "自閉症譜系障礙 (ASD 高功能)", type: "health_condition" },
      { text: "社交情緒互動缺陷，非言語溝通解讀困難，感官過載敏感", type: "body_functions" },
      { text: "難以進行開放式社交閒聊，面試答案較為簡短直白", type: "activities" },
      { text: "畢業後待業12個月，每日在家重覆排列模型與整理檔案", type: "participation" },
      { text: "【阻礙】傳統面試偏重流利口才與社交寒暄，僱主缺乏對 ASD 的認識", type: "environmental_factors" },
      { text: "【促進】社會福利署「陽光路上計劃」提供個案輔導與職場導師 (Job Coach)", type: "environmental_factors" },
      { text: "【促進】友善機構提供「職務再設計 (Job Redesign)」，專注數據輸入與檔案分類", type: "environmental_factors" },
      { text: "22歲，特殊學校職業培訓畢業，專注力與規則遵守度極高 (100%)", type: "personal_factors" },
      { text: "內在核心價值：遵守規則、追求秩序與精確、希望能有固定工作自立", type: "personal_factors" }
    ],
    initial_dialogue: "「社工，我不喜歡面試官問我『你的優點是什麼』這種問題。我不知道什麼是優點。我只想知道工作的具體 SOP 步驟。如果步驟明確，我可以連續整理 8 小時不會出錯。但是面試官說我眼神不看他、沒有禮貌……」",
    roleplay_flow: [
      {
        user: "家豪，我很欣賞你對工作規則和精確度的堅持！你說得對，很多面試過於看重流利說話，卻忽略了你連續 8 小時精準整理檔案的超強專注力。我們中心有『陽光路上計劃』，可以安排 Job Coach 陪你實地試工，向僱主展示你的整理作品，你願意試試嗎？",
        ai_reply: "「如果有明確的 SOP 檔案整理指引，而且不需要處理顧客寒暄，我很願意去試工！請告訴我試工的確切日期和地址。」",
        coach_hint: "【ICF/輔導提示】：家豪對於結構化指令回應極佳！此時應運用合理便利（Job Coach 職場導師陪同 + 職務再設計），發揮其專注與規則遵守的核心優勢。"
      }
    ]
  },
  {
    id: "case_sensory_meiling",
    name: "美玲 (感官與軀體 - 聽障及慢性關節痛)",
    category: "感官與軀體障礙",
    avatar: "🦻",
    age: 41,
    gender: "女",
    health_condition: "中度感音神經性聽力損失 (雙耳助聽器) 伴隨退化性腰椎關節炎",
    previous_job: "中小企行政文員 (工作12年)",
    family: "已婚，育有一名中學身心障礙女兒，丈夫為兼職司機",
    welfare: "無綜援，申請「殘疾僱員輔助設備及改善工作場所資助計劃」",
    emotional_state: "因公司結業失業，兼具電話聽力困難與無法久坐的雙重障礙，對成為家庭負擔感到極度焦慮。",
    icf_factors: [
      { text: "中度聽力損失及退化性腰椎關節炎", type: "health_condition" },
      { text: "雙耳聽力受損，腰椎久坐超逾 45 分鐘引發劇痛", type: "body_functions" },
      { text: "聽電話需輔助字幕，需定時站立伸展", type: "activities" },
      { text: "失業8個月，擔心無法賺錢負擔女兒復康治療費用", type: "participation" },
      { text: "【促進】政府「殘疾僱員輔助設備資助計劃」(最高資助$40,000)", type: "environmental_factors" },
      { text: "【促進】社福機構「輔助就業 (SE)」轉介彈性人體工學座椅與字幕電話文職", type: "environmental_factors" },
      { text: "41歲，資深行政文員，熟悉 Excel、會計及文書處理", type: "personal_factors" },
      { text: "內在核心價值：母愛與家庭承擔、專業文職尊嚴", type: "personal_factors" }
    ],
    initial_dialogue: "「社工，我年紀大，對耳又要戴助聽器聽唔清電話，條腰坐得耐少少就痛到行唔到。我想去做清潔又夠唔夠力，想做返文員又人哋嫌我聽唔到電話……我個女仲讀緊書，我真係好絕望……」",
    roleplay_flow: [
      {
        user: "美玲，聽得出你肩負住照顧女兒同家庭嘅重大責任，呢份母愛同堅韌真係好令人敬佩。雖然聽力同腰痛帶來左限制，但你擁有 12 年豐富嘅 Excel 同會計文書經驗，這正是很多社企同友好機構最需要的才華！我們可以申請政府的輔助設備資助，為你配備人體工學升降桌同字幕電話，你覺得這對你的文職工作會有幫助嗎？",
        ai_reply: "「真係有升降桌同字幕電話資助？如果唔使一直坐死喺度，又可以用文字同字幕處理文書，我非常有信心能做返好文員工作！多謝你讓我看到希望……」",
        coach_hint: "【輔導成功！】成功的運用環境促成因素（合理便利輔助設備）結合案主的核心專業（12年文書經驗），打消了案主對疾病障礙的恐懼。"
      }
    ]
  }
];
